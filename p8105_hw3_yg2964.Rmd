...
# View a sample of the combined data
head(citi_total_df)

```

The resulting dataset, citi_total_df, contains Citi Bike ride data for January and July of 2020 and 2024, with a total of `r nrow(citi_total_df)` rides, featuring key columns such as rideable_type, start_station_name, end_station_name, duration, and member_casual
